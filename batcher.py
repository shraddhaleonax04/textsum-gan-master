...
class Batcher(object):
    ...
    def __init__(self, data_path, vocab, hps, single_pass, BATCH_QUEUE_MAX=100):
        ...
        self._example_queue = queue.Queue(BATCH_QUEUE_MAX * self._hps.batch_size._value)
    ...
    def fill_batch_queue(self):
        ...
        while True:
            if self._hps.mode != 'decode':
                ...
                inputs = []
                for _ in range(self._hps.batch_size._value * self._bucketing_cache_size._value):
